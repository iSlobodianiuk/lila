...
// Arrows (Ladders): 10→23, 22→58, 27→41, 54→68
// Snakes: 12→8, 44→9, 55→3, 61→13, 72→51
const BOARD_CELLS_BASE: CellBase[] = [
  ...
  { id: 9, name: "Зона комфорту", original: "Kama Loka" },
  ...
  { id: 28, name: "Істинна віра", original: "Saguna" },
  { id: 29, name: "Знецінення", original: "Adharma" },
  ...
  { id: 37, name: "Справжня мудрість", original: "Jnana" },
  ...
  { id: 45, name: "Правильне знання", original: "Vidya" },
  { id: 46, name: "Розрізнення", original: "Viveka" },
  ...
  { id: 52, name: "Насильство", original: "Himsa" },
  ...
  { id: 63, name: "Бездіяльність", original: "Tamas" },
